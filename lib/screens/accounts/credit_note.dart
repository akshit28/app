...
class _CreditNoteState extends State<CreditNote> {
  ...
  populateFacilities() async {
    ...
    if (facility.length == 1) {
      ...
      getCreditNotes(facility[0].id, selectedYear, selectedMonth);
    }
    setState(() {});
  }
  ...
  Future selectMonth(BuildContext context) async {
    ...
    if (picked != null) {
      ...
      getCreditNotes(defaultFacility, selectedYear, selectedMonth);
      // getStatement(selectedMonth, selectedYear, defaultFacility);
    }
  }

  Future getCreditNotes(String facility, String year, String month) async {
    var account = AccountService();
    creditNotes.clear();
    loading = true;

    final data = await account.fetchCreditNote(facility, year, month);
        ...
        child: Column(
          children: [
            ...
            loading
                ...
                : Visibility(
                    visible: creditNotes.isNotEmpty ? true : false,
                    child: Padding(
                                                  ...
                                                  child: RichText(
                                                    text: TextSpan(
                                                        ...
                                                        children: [
                                                          TextSpan(
                                                            text:
                                                                DateFormat("dd-MM-yy").format(DateTime.parse(note.date.toString()).toLocal()),
                                                            style: const TextStyle(
                                                                fontWeight:
                                                                    FontWeight
                                                                        .bold,
